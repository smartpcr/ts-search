...
describe("Search", function() {
    let documentBar: Object, documentBaz: Object, documentFoo: Object, nestedDocumentFoo: Object, search: Search;

    const validateSearchResults = function(results: Array<Object>, expectedDocuments: Array<Object>): void {
    ...
    it("should index a new document on all searchable fields", function() {
        ...
        spyOn((search as any)._indexStrategy, "expandToken").and.returnValue([]);
        search.addDocument(documentBar);
        expect((search as any)._indexStrategy.expandToken).toHaveBeenCalledWith("bar");
    });
    ...
    it("should stringified arrays", function() {
        ...
        search.setDocuments([documentFoo, documentBaz]);
    ...
    it("should support nested uid paths", function() {
        ...
        search.setDocuments([melissaSmith, johnSmith]);
